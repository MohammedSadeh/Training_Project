class special_single_wrap_point_mode_seq extends base_seq;

    `uvm_object_utils(special_single_wrap_point_mode_seq)

    function new(string name="special_single_wrap_point_mode_seq");
    endfunction

    //override this in the derived classes
    virtual task body();
        //configure the counter
        config_counter(.run_mode(SPECIAL_SINGLE_WRAP_POINT_MODE));
